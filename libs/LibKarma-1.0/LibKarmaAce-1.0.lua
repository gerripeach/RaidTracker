if KarmaStub:isLib("LibKarmaAce", 1.1, "$Revision: 61 $") then return end
...
--[[
	...
	High level table structure (yes confusing):
		...
		[inst]._acelib		-- (aka _inst)
			...
			instance		-- the Ace3 real (or mockup) instance (this is where all the splicing and things come together)
